...
public sealed class CitizenAnimation : Component, Component.ExecuteInEditor
{
    ...
    [Property] public GameObject EyeSource { get; set; } = null!;

    [Property] public GameObject LookAtObject { get; set; } = null!;

    [Property, Range( 0.5f, 1.5f)] public float Height { get; set; } = 1.0f;


    [Property] public GameObject IkLeftHand { get; set; } = null!;
	[Property] public GameObject IkRightHand { get; set; } = null!;
    [Property] public GameObject IkLeftFoot { get; set; } = null!;
    [Property] public GameObject IkRightFoot { get; set; } = null!;
